namespace Contable.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        {
            public const string SocialConflictAlertSubject = "App.Template.SocialConflictAlertSubject";
            public const string SocialConflictAlertTemplate = "App.Template.SocialConflictAlertTemplate";

            public const string TaskManagementAlertSubject = "App.Template.TaskManagementAlertSubject";
            public const string TaskManagementAlertExpirationSubject = "App.Template.TaskManagementAlertExpirationSubject";
            public const string TaskManagementAlertNotificationSubject = "App.Template.TaskManagementAlertNotificationSubject";
            public const string TaskManagementAlertTemplate = "App.Template.TaskManagementAlertTemplate";

            public const string SocialConflictTaskManagementAlertSubject = "App.Template.SCTaskManagementAlertSubject";
            public const string SocialConflictTaskManagementAlertExpirationSubject = "App.Template.SCTaskManagementAlertExpirationSubject";
            public const string SocialConflictTaskManagementAlertNotificationSubject = "App.Template.SCTaskManagementAlertNotificationSubject";
            public const string SocialConflictTaskManagementAlertTemplate = "App.Template.SCTaskManagementAlertTemplate";

            public const string QuizCustomerSubject = "App.Template.QuizCustomerSubject";
            public const string QuizCustomerBody = "App.Template.QuizCustomerBody";

            public const string QuizAdminSubject = "App.Template.QuizAdminSubject";
            public const string QuizAdminBody = "App.Template.QuizAdminBody";
        }
