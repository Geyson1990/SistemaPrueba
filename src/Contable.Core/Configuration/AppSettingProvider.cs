...
using Contable.DashboardCustomization;
...
namespace Contable.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!ContableConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetHostSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.UiManagement.Theme,
                    GetFromAppSettings(AppSettings.UiManagement.Theme, "theme11"), isVisibleToClients: true,
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        ContableConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),

                //New Settings
                new SettingDefinition(AppSettings.Template.SocialConflictAlertSubject,
                    GetFromAppSettings(AppSettings.Template.SocialConflictAlertSubject, "Alerta PCM {0} {1}"), scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.Template.SocialConflictAlertTemplate,
                    GetFromAppSettings(AppSettings.Template.SocialConflictAlertTemplate, ""), scopes: SettingScopes.Tenant),

                new SettingDefinition(AppSettings.Template.TaskManagementAlertSubject,
                    GetFromAppSettings(AppSettings.Template.TaskManagementAlertSubject, "Alerta de creación de tarea"), scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.Template.TaskManagementAlertExpirationSubject,
                    GetFromAppSettings(AppSettings.Template.TaskManagementAlertExpirationSubject, "Alerta de vencimiento de tarea"), scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.Template.TaskManagementAlertNotificationSubject,
                    GetFromAppSettings(AppSettings.Template.TaskManagementAlertNotificationSubject, "Alerta de notificación de tarea"), scopes: SettingScopes.Tenant),                
                new SettingDefinition(AppSettings.Template.TaskManagementAlertTemplate,
                    GetFromAppSettings(AppSettings.Template.TaskManagementAlertTemplate, ""), scopes: SettingScopes.Tenant),

                new SettingDefinition(AppSettings.Template.SocialConflictTaskManagementAlertSubject,
                    GetFromAppSettings(AppSettings.Template.SocialConflictTaskManagementAlertSubject, "Alerta de creación de tarea"), scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.Template.SocialConflictTaskManagementAlertExpirationSubject,
                    GetFromAppSettings(AppSettings.Template.SocialConflictTaskManagementAlertExpirationSubject, "Alerta de vencimiento de tarea"), scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.Template.SocialConflictTaskManagementAlertNotificationSubject,
                    GetFromAppSettings(AppSettings.Template.SocialConflictTaskManagementAlertNotificationSubject, "Alerta de notificación de tarea"), scopes: SettingScopes.Tenant),                
                new SettingDefinition(AppSettings.Template.SocialConflictTaskManagementAlertTemplate,
                    GetFromAppSettings(AppSettings.Template.SocialConflictTaskManagementAlertTemplate, ""), scopes: SettingScopes.Tenant),

                new SettingDefinition(AppSettings.Template.QuizCustomerSubject,
                    GetFromAppSettings(AppSettings.Template.QuizCustomerSubject, ""), scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.Template.QuizCustomerBody,
                    GetFromAppSettings(AppSettings.Template.QuizCustomerBody, ""), scopes: SettingScopes.Tenant),

                new SettingDefinition(AppSettings.Template.QuizAdminSubject,
                    GetFromAppSettings(AppSettings.Template.QuizAdminSubject, ""), scopes: SettingScopes.Tenant),
                new SettingDefinition(AppSettings.Template.QuizAdminBody,
                    GetFromAppSettings(AppSettings.Template.QuizAdminBody, ""), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetSharedSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.UserManagement.SessionTimeOut.IsEnabled,
                    GetFromAppSettings(AppSettings.UserManagement.SessionTimeOut.IsEnabled, "true"),
                ...
                new SettingDefinition(AppSettings.UserManagement.SessionTimeOut.TimeOutSecond,
                    GetFromAppSettings(AppSettings.UserManagement.SessionTimeOut.TimeOutSecond, "900"),
                    isVisibleToClients: true, scopes: SettingScopes.Application | SettingScopes.Tenant),
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    ...
                    ContableDashboardCustomizationConsts.Applications.Mvc, mvcDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true),
                new SettingDefinition(
                    AppSettings.DashboardCustomization.Configuration + "." +
                    ContableDashboardCustomizationConsts.Applications.Angular, angularDefaultSettingsJson,
                    scopes: SettingScopes.User, isVisibleToClients: true)
            };
        }
        ...
        public List<Dashboard> GetDefaultMvcDashboardViews()
        {
            ...
            return new List<Dashboard>
            {
                new Dashboard
                {
                    DashboardName = ContableDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            Name = ContableDashboardCustomizationConsts.DefaultPageName,
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = ContableDashboardCustomizationConsts.Widgets.Tenant
                                ...
                                {
                                    WidgetId =
                                        ContableDashboardCustomizationConsts.Widgets.Tenant
                ...
                new Dashboard
                {
                    DashboardName = ContableDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Widgets = new List<Widget>
                            {
                                new Widget
                                {
                                    WidgetId = ContableDashboardCustomizationConsts.Widgets.Host
                                        .TopStats, // Top Stats
                                    Height = 6,
                                    Width = 12,
                                    PositionX = 0,
                                ...
                                {
                                    WidgetId =
                                        ContableDashboardCustomizationConsts.Widgets.Host
