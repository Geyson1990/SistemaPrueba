...
{
    public class StripeGatewayManager : ContableServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Contable";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ContableConsts.Currency;
        }
