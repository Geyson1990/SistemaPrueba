...
using Contable.Web.Controllers;
using Contable.Web.Models.Consent;

namespace Contable.Web.Host.Controllers
{
    public class ConsentController : ContableControllerBase
    {
