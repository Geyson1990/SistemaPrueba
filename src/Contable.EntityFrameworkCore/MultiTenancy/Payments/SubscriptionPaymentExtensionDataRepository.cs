...
{
    public class SubscriptionPaymentExtensionDataRepository : ContableRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ContableDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
