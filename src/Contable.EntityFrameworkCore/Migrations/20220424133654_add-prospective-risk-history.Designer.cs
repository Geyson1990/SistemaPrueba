...
namespace Contable.Migrations
{
    ...
    [Migration("20220424133654_add-prospective-risk-history")]
    partial class addprospectiveriskhistory
    {
            ...
            modelBuilder.Entity("Contable.Application.ProspectiveRiskHistoryDetail", b =>
                {
                    ...
                    b.HasOne("Contable.Application.StaticVariable", "StaticVariablen")
                        .WithMany()
                        .HasForeignKey("StaticVariableId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
