...
namespace Contable.Migrations
{
    ...
    [Migration("20220512150615_add-social-conflict-analyst")]
    partial class addsocialconflictanalyst
    {
            ...
            modelBuilder.Entity("Contable.Application.AnalystTerritorialUnit", b =>
                {
                    ...
                    b.Property<int>("TerrotorialUnitId")
                        .HasColumnType("INT");
            ...
            modelBuilder.Entity("Contable.Application.AnalystTerritorialUnit", b =>
                {
                    ...
                    b.HasOne("Contable.Application.TerritorialUnit", "TerrotorialUnit")
                        .WithMany()
                        .HasForeignKey("TerrotorialUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
