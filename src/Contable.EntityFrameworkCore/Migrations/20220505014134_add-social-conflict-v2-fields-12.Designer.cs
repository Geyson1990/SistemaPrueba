...
namespace Contable.Migrations
{
    ...
    [Migration("20220505014134_add-social-conflict-v2-fields-12")]
    partial class addsocialconflictv2fields12
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Contable.Application.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Contable.Application.SocialConflict", b =>
                {
                    ...
                    b.Property<string>("ExternalCaseName")
                        .HasColumnType("VARCHAR(1000)");
                    ...
                    b.Property<string>("ResourceContext")
                        .HasColumnType("VARCHAR(1000)");
            ...
            modelBuilder.Entity("Contable.Application.SocialConflictObservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppSocialConflictObservations");
                });

            modelBuilder.Entity("Contable.Application.SocialConflictSector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppSocialConflictSectors");
                });
            ...
            modelBuilder.Entity("Contable.Application.SocialConflictState", b =>
                {
                    ...
                    b.ToTable("SocialConflictStates");
                });
            ...
            modelBuilder.Entity("Contable.Application.SubActor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("AppSubActors");
                });

            modelBuilder.Entity("Contable.Application.SubSector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Contable.Application.SocialConflict", b =>
                {
                    ...
                    b.HasOne("Contable.Application.SubSector", "SubSector")
                        .WithMany()
            ...
            modelBuilder.Entity("Contable.Application.SocialConflictActor", b =>
                {
                    b.HasOne("Contable.Application.Actor", "Actor")
                        .WithMany()
                    ...
                    b.HasOne("Contable.Application.SubActor", "SubActor")
                        .WithMany()
                        .HasForeignKey("SubActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
