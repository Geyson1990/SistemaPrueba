...
{
    public partial class addsocialconflictalertresource : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AppSocialConflictAlertResources",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSocialConflictAlertResources", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppSocialConflictAlertResources_AppSocialConflictAlerts_SocialConflictAlertId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppSocialConflictAlertResources_SocialConflictAlertId",
