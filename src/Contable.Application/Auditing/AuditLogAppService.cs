...
using Contable.Auditing.Exporting;
using Contable.Authorization;
using Contable.Authorization.Users;
using Contable.Dto;
using Contable.EntityHistory;
using EntityHistoryHelper = Contable.EntityHistory.EntityHistoryHelper;

namespace Contable.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ContableAppServiceBase, IAuditLogAppService
    {
