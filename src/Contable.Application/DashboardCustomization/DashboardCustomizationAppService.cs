...
using Contable.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Contable.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ContableAppServiceBase, IDashboardCustomizationAppService
    {
