...
using Contable.DemoUiComponents.Dto;

namespace Contable.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : ContableAppServiceBase, IDemoUiComponentsAppService
    {
